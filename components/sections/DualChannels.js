...
const channels = [
  ...
  },
  {
    ...
    desc: "Onde o celular é restrito, o rádio digital continua o canal da operação. A voz entra na mesma trilha de tratativa da SSMA.",
    image: "/images/field-radio.jpg",
    alt: "Operador em mina a céu aberto fazendo relato pelo rádio",
    points: [
      "Ferramenta que a operação já usa",
      "Funciona em áreas com restrição de celular",
      "Mesmo painel e e-mail da SSMA",
    ],
